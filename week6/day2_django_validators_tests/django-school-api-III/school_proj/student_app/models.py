...
from .validators import validate_student_name, validate_school_email, validate_locker_combination

# Create your models here.
class Student(models.Model):
    name = models.CharField(max_length=255, null = False, blank = False, validators=[validate_student_name])
